    ...
    <div className="hero-banner-section" style={{ position: 'relative', width: '100%' }}>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(320px, 1fr))', gap: '2.5rem', alignItems: 'center', margin: '3rem 0' }}>
        <div>
          ...
          <h2 className="section-heading" style={{ fontSize: 'clamp(2.2rem, 5vw, 4rem)', marginBottom: '1.2rem', color: '#1A1816' }}>
          ...
          <p style={{ color: 'var(--text-secondary)', fontSize: '1.1rem', lineHeight: 1.8, marginBottom: '1.5rem', fontWeight: 500 }}>
            {hero?.description || "Full-stack developer, creative coder, and IoT engineer. When I'm not configuring microcontrollers or designing 3D web experiences, I'm exploring new realms in creative AI, photography, and music."}
          </p>
          <div style={{ display: 'flex', gap: '1rem', flexWrap: 'wrap' }}>
            <div style={{ padding: '0.8rem 1.2rem', background: 'rgba(230, 57, 70, 0.08)', borderLeft: '4px solid var(--accent-rose)', borderRadius: '4px' }}>
              <div style={{ fontFamily: 'var(--font-mono)', fontSize: '0.75rem', color: 'var(--accent-rose)', fontWeight: 700 }}>CURRENT FOCUS</div>
              <div style={{ fontWeight: 700, fontSize: '0.95rem', color: '#1A1816' }}>AI Robotics & Next.js Systems</div>
            </div>
            <div style={{ padding: '0.8rem 1.2rem', background: 'rgba(42, 157, 143, 0.08)', borderLeft: '4px solid var(--accent-teal)', borderRadius: '4px' }}>
              <div style={{ fontFamily: 'var(--font-mono)', fontSize: '0.75rem', color: 'var(--accent-teal)', fontWeight: 700 }}>EDUCATION</div>
              <div style={{ fontWeight: 700, fontSize: '0.95rem', color: '#1A1816' }}>B.Tech CSE &bull; Class of &apos;28</div>
            </div>
          </div>
        </div>
